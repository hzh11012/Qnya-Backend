                  ...
                  >
                    {selected.length > 0
                      ? selected.map(val => (
                          <div
                            key={val}
                            className='animate-fadeIn bg-background relative inline-flex h-6.5 cursor-default items-center rounded-md border ps-2 pe-7 text-xs font-medium transition-all'
                          >
