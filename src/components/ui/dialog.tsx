  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'grid max-w-[calc(100%-2rem)] gap-6 rounded-2xl border-border/60 bg-background/80 p-6 shadow-lg backdrop-blur-xl duration-100 sm:max-w-md fixed top-1/2 left-1/2 z-50 w-full -translate-x-1/2 -translate-y-1/2 outline-none',
